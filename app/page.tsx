...
export default function Page() {
  ...
  return <div className={`app-shell ${darkMode ? 'dark-mode' : ''}`}>
    ...
    <main className="main-content">
      ...
      {sapDetails && <SapIntegrationModal detail={sapDetails} onClose={() => setSapDetails(null)} />}{fieldModeOpen && <FieldModeModal onClose={() => setFieldModeOpen(false)} onRequestPart={() => { setFieldModeOpen(false); setRequestModal(true) }} />}{paletteOpen && <CommandPalette onClose={() => setPaletteOpen(false)} onNavigate={(nextView) => { setView(nextView); setPaletteOpen(false) }} />}
